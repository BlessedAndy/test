...
#             Delivery_options = driver.find_element_by_id('Delivery options').text
            Delivery_options = driver.find_element_by_xpath('//*[@id="react-views-container"]/div/div/div/div[1]/div/div/div/div[1]/div[3]/div/div/div/div[2]/div/h1').text
        ...
        if(Delivery_options != 'No delivery times available'):
